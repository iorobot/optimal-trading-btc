...
class Backtest(Base):# è figlio di BASE!
    """
    ...
    def trade(self, actions, wallet, trades, force_sell=True):
        ...
        """
        return super(Backtest, self).trade(actions, wallet, trades, force_sell=False)#Backtest usa la funzione trade del padre(BASE)
